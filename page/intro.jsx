...
import { LinkExtern, LinkIntern } from './link.jsx'
...
<>
  <div class='xl:absolute top-0 left-2 h-2 w-full
    ...
    <p class='capitalize font-bold text-h2 md:text-3xl'>sections</p>
...
<Link ref={ link } href={ url }
  ...
  <p class='font-bold text-h3 md:text-3xl transition
...
<div class='xl:mt-15 space-y-20 xl:space-y-0
  ...
  <div class='row-start-2 self-center xl:ml-15 xl:max-w-max
    ...
    <MenuFrame/>
    <div class='pt-20 md:pt-10 xl:pt-25 xl:pl-25'>
